...
/**
 * joinTrees method completed by Spencer Poultney
 */
...
/**
 * findHeight method completed by Spencer Poultney
 */

//Recursively counts each node on the far left side of the tree
int leftHeight = findHeight(node.getLeft());

//Recursively counts each node on the far right side of the tree
int rightHeight = findHeight(node.getRight());

//If the height of the left side is greater than the height of the right side return the left height plus one count for the root.
if (leftHeight > rightHeight){
	return leftHeight + 1;
}
else{
	//Otherwise return the right height plus one count for the root.
...
/**
 * countBinaryTreeNodes method completed by Spencer Poultney
 */

//Recursively scales through the tree and counts every node within it
...
if(root!=null) 
  ...
  // YOUR CODE HERE
	...
	/**
	 * inOrder traversal method completed by Spencer Poultney
	 */
	
	//Makes a string which uses recursion to traverse through the tree in an in order fashion and concatenate into a single string
	stg = stg + preOrder(root.getLeft(), stg) + root.getElement() + " " + preOrder(root.getRight(), stg);
  }
return stg;
} // inOrder
...
if(root!=null) 
  ...
  // YOUR CODE HERE
	...
	/**
	 * preOrder traversal method completed by Spencer Poultney
	 */
	
	//Makes a string which uses recursion to traverse through the tree in an pre order fashion and concatenate into a single string
...
if(root!=null) 
  ...
  // YOUR CODE HERE
	...
	/**
	 * postOrder traversal method completed by Spencer Poultney
	 */
	
	//Makes a string which uses recursion to traverse through the tree in an post order fashion and concatenate into a single string
	stg = stg + preOrder(root.getLeft(), stg) + preOrder(root.getRight(), stg) + root.getElement() + " ";
}
return stg;
}
 // postOrder
